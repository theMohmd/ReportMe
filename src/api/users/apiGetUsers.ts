...
//   input: apiGetUsersInputType,
// ) => Promise<apiGetUsersOutputType> = async (
//   data: apiGetUsersInputType = { input: "", mode: "" },
// ) => {
//   return axios
//     .get("http://127.0.0.1:8000/api/users", {
//       params:
//         data.mode === "email" ? { email: data.input } : { name: data.input },
//       headers: {
...
export const apiGetUsers: (
  ...
  console.log(data);
  return new Promise((res) => setTimeout(() => res(demoUsers), 500));
};
